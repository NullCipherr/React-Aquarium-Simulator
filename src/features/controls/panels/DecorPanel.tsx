...
import type { DecorationType, EnvironmentType } from '../../../types';
        ...
        <div className="flex flex-col gap-5">
            ...
            <div>
                 ...
                 <div className="grid grid-cols-2 gap-3 mb-3">
                    <button type="button" onClick={() => onAddDecoration('plant')} className="bg-green-700 hover:bg-green-600 text-white font-semibold py-2 px-3 rounded-lg transition-colors shadow-sm">
                        + Plant
                    </button>
                    <button type="button" onClick={() => onAddDecoration('rock')} className="bg-gray-600 hover:bg-gray-500 text-white font-semibold py-2 px-3 rounded-lg transition-colors shadow-sm">
                        + Rock
                    </button>
                </div>
                <button type="button" onClick={onClearDecorations} className="w-full flex items-center justify-center bg-red-900/50 hover:bg-red-800 text-red-200 border border-red-800 font-semibold py-2 px-4 rounded-lg transition-colors">
                    <TrashIcon /> Clear All
                </button>
            </div>
             ...
             <div>
                <h3 className="text-sm font-semibold text-gray-400 mb-2 uppercase tracking-wider">Maintenance</h3>
                 <div className="flex flex-col gap-2">
                    <button type="button" onClick={onCleanAlgae} className="flex items-center justify-center bg-teal-700 hover:bg-teal-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm">
                        Scrub Algae
                    </button>
                    <button type="button" onClick={onWaterChange} className="flex items-center justify-center bg-cyan-700 hover:bg-cyan-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm">
